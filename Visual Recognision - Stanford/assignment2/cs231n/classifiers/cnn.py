...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W1'] = np.random.normal(mu, sigma, (num_filters, input_dim[0], filter_size, filter_size))
        self.params['b1'] = np.zeros(num_filters)
        self.params['W2'] = np.random.normal(mu, sigma, (
            num_filters * (input_dim[1] / 2) * (input_dim[2] / 2), hidden_dim))  # use fc to conv trick
    ...
    def loss(self, X, y=None):
        ...
        # backprop
        dout1, dw3, db3 = affine_backward(dloss, cache3)
        dout2, dw2, db2 = affine_relu_backward(dout1, cache2)
        dx, dw1, db1 = conv_relu_pool_backward(dout2, cache1)

        # add regularization to wights
